-- Upstream UDP jitter
--
-- This script produces results for upstream UDP jitter measurements (64k/s stream).
--
...
INSERT unit_udpjitter_pct99 SELECT unit_id, MEDIAN(jitter_up,2,1), MEDIAN(jitter_up,2,99) FROM curr_udpjitter GROUP BY unit_id;
...
LEFT JOIN
(
   SELECT curr_udpjitter.unit_id, 'Off-Peak Mon-Sun' AS period, MIN(jitter_up) AS min, MAX(jitter_up) AS max, AVG(jitter_up) AS mean,
          AVG(IF(jitter_up < perc1 OR jitter_up > perc99, NULL, jitter_up)) AS trimmed_mean,
          MEDIAN(jitter_up,2,10) AS 10_pct, MEDIAN(jitter_up,2,90) AS 90_pct, MEDIAN(jitter_up,2,8) AS 8_pct, MEDIAN(jitter_up,2,92) AS 92_pct, MEDIAN(jitter_up,2,5) AS 5_pct,
          MEDIAN(jitter_up,2,95) AS 95_pct, MEDIAN(jitter_up,2,3) AS 3_pct, MEDIAN(jitter_up,2,97) AS 97_pct, 
          MEDIAN(jitter_up,2,99) AS 99_pct, MEDIAN(jitter_up) AS median, STDDEV(jitter_up) AS stddev,
                  STDDEV(IF(jitter_up < perc1 OR jitter_up > perc99, NULL, jitter_up)) AS trimmed_stddev,
...
LEFT JOIN
(
   SELECT curr_udpjitter.unit_id, '24hr Sat-Sun' AS period, MIN(jitter_up) AS min, MAX(jitter_up) AS max, AVG(jitter_up) AS mean,
          AVG(IF(jitter_up < perc1 OR jitter_up > perc99, NULL, jitter_up)) AS trimmed_mean, 
          MEDIAN(jitter_up,2,10) AS 10_pct, MEDIAN(jitter_up,2,90) AS 90_pct, MEDIAN(jitter_up,2,8) AS 8_pct, MEDIAN(jitter_up,2,92) AS 92_pct, MEDIAN(jitter_up,2,5) AS 5_pct,
          MEDIAN(jitter_up,2,95) AS 95_pct, MEDIAN(jitter_up,2,3) AS 3_pct, MEDIAN(jitter_up,2,97) AS 97_pct,
          MEDIAN(jitter_up,2,99) AS 99_pct, MEDIAN(jitter_up) AS median, STDDEV(jitter_up) AS stddev,
...
LEFT JOIN
(
   SELECT curr_udpjitter.unit_id, '1900-2200 Mon-Fri' AS period, MIN(jitter_up) AS min, MAX(jitter_up) AS max, AVG(jitter_up) AS mean,
          AVG(IF(jitter_up < perc1 OR jitter_up > perc99, NULL, jitter_up)) AS trimmed_mean, 
          MEDIAN(jitter_up,2,10) AS 10_pct, MEDIAN(jitter_up,2,90) AS 90_pct, MEDIAN(jitter_up,2,8) AS 8_pct, MEDIAN(jitter_up,2,92) AS 92_pct, MEDIAN(jitter_up,2,5) AS 5_pct,
          MEDIAN(jitter_up,2,95) AS 95_pct, MEDIAN(jitter_up,2,3) AS 3_pct, MEDIAN(jitter_up,2,97) AS 97_pct,
          MEDIAN(jitter_up,2,99) AS 99_pct, MEDIAN(jitter_up) AS median, STDDEV(jitter_up) AS stddev,
...
LEFT JOIN
(
   SELECT curr_udpjitter.unit_id, '0900-1600 Mon-Fri' AS period, MIN(jitter_up) AS min, MAX(jitter_up) AS max, AVG(jitter_up) AS mean,
          AVG(IF(jitter_up < perc1 OR jitter_up > perc99, NULL, jitter_up)) AS trimmed_mean, 
          MEDIAN(jitter_up,2,10) AS 10_pct, MEDIAN(jitter_up,2,90) AS 90_pct, MEDIAN(jitter_up,2,8) AS 8_pct, MEDIAN(jitter_up,2,92) AS 92_pct, MEDIAN(jitter_up,2,5) AS 5_pct,
          MEDIAN(jitter_up,2,95) AS 95_pct, MEDIAN(jitter_up,2,3) AS 3_pct, MEDIAN(jitter_up,2,97) AS 97_pct,
          MEDIAN(jitter_up,2,99) AS 99_pct, MEDIAN(jitter_up) AS median, STDDEV(jitter_up) AS stddev,
